...
public class ClusterAdapter extends RecyclerView.Adapter<ClusterAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View itemView) {
            ...
            office_name = itemView.findViewById(R.id.office_name2);
            office_rent = itemView.findViewById(R.id.office_rent2);
            office_type = itemView.findViewById(R.id.office_type2);
            office_stdaddr = itemView.findViewById(R.id.office_stdaddr2);
            office_img = itemView.findViewById(R.id.office_img2);
    ...
    public ClusterAdapter(ArrayList<OfficeDTO> boardList, LayoutInflater l, RequestManager r, Activity a) {
    ...
    public ClusterAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view;
        view = inflater.inflate(R.layout.officelist_horizon, parent, false);

        ClusterAdapter.ViewHolder vh = new ClusterAdapter.ViewHolder(view);
        return vh;

    }

    @Override
    public void onBindViewHolder(@NonNull final ClusterAdapter.ViewHolder holder, int position) {
        URL url = null;
        String rent;
        String type;
...
//        glide.load("http://192.168.219.131:8090/reo/resources/upload/" + boardList.get(position).getOff_image()).into(holder.office_img);
    }
