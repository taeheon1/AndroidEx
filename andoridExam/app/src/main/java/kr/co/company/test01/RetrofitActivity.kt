...
class RetrofitActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val retrofit = Retrofit.Builder()
            ...
            .build()
        val service =
            retrofit.create(RetrofitService::class.java) // service 를 통하여 데이터 통신을 진행한다. Retrofit을 사용할 준비가 됨. interface를 service라는 객체로 만듬
        ...
        service.getStudentList().enqueue(object :
            ...
            override fun onResponse( // -> 통신성공
                ...
                if (response.isSuccessful) { //200번때 통신이 잘된경우 boolean 타입
                    ...
                    val header = response.headers() //인증정보 , 내가 보낼 데이터의 요약본
